...
int max_contigous_k_neg_withS(vector<int>& arr, int S, int k){
    int n = arr.size();
    int sum = 0;
    int res = INT_MIN;
...
int main(){
    ...
    vector<int> arr = {2, -1, 4, -3, 5, -1, 2};
    cout << max_contigous_k_neg_withS(arr, 6, 2) << endl;

     arr = {2, -1, 4, -3, 5000, -1, 2};
    cout << max_contigous_k_neg_withS(arr, 600000, 2) << endl;
